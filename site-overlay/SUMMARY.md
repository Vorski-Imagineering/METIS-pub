...
- [METIS Docs](docs-pub/index.md)
    ...
    - Core
        ...
        - [Using the Chrome extension](docs-pub/extension/using-the-extension.md)
            - [Outreach with the extension, day to day](docs-pub/extension/outreach-in-your-day.md)
    - Coherence
        ...
        - [IRIS](docs-pub/metis_apps/coherence/iris/index.md)
            ...
            - [Step reference](docs-pub/metis_apps/coherence/iris/steps/index.md)
                ...
                - [11a. Podcast RSS platform connection guide](docs-pub/metis_apps/coherence/iris/IRIS-podcast-RSS-platform-connection-guide.md)
                ...
                - [16a. LinkedIn Link Resolver](docs-pub/metis_apps/coherence/iris/steps/linkedin-link-resolver.md)
