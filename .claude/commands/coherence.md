...
Full endpoint reference, auth model, and golden paths are in `METIS-api/coherence/PLAYBOOK.md` —
...
- All of this is read-only browsing. If the user asks to *update* a conversation (`infos`/`config`
  ...
  corresponding Golden Path in `METIS-api/coherence/PLAYBOOK.md` first — those endpoints have
